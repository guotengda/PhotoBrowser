...
public class PhotoBrowserPageCell: UICollectionViewCell {
...
extension PhotoBrowserPageCell {
    /// 响应单击
...
extension PhotoBrowserPageCell: UIScrollViewDelegate {
...
extension PhotoBrowserPageCell: UIGestureRecognizerDelegate {
